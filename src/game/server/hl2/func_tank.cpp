...
BEGIN_DATADESC( CFuncTank )
	...
	DEFINE_KEYFIELD( m_flBulletDamage, FIELD_FLOAT, "bullet_damage" ),
	DEFINE_KEYFIELD( m_flBulletDamageVsPlayer, FIELD_FLOAT, "bullet_damage_vs_player" ),
...
{
	m_flBulletDamage = inputdata.value.Float();
}
...
void CFuncTankGun::Fire( int bulletCount, const Vector &barrelEnd, const Vector &forward, CBaseEntity *pAttacker, bool bIgnoreSpread )
{
	...
	info.m_flDamage = m_flBulletDamage;
	info.m_flPlayerDamage = m_flBulletDamageVsPlayer;
...
void CFuncTankPulseLaser::Fire( int bulletCount, const Vector &barrelEnd, const Vector &vecForward, CBaseEntity *pAttacker, bool bIgnoreSpread )
{
	...
	for ( int i = 0; i < bulletCount; i++ )
	{
		...
		pPulse->Shoot(vecDir,m_flPulseSpeed,m_flPulseLife,m_flPulseLag,m_flBulletDamage);
...
void CFuncTankRocket::Fire( int bulletCount, const Vector &barrelEnd, const Vector &forward, CBaseEntity *pAttacker, bool bIgnoreSpread )
{
	...
	{
		pRocket->SetDamage( m_flBulletDamage );
	}
	else
	{
		pRocket->SetDamage( m_flBulletDamageVsPlayer );
	}
