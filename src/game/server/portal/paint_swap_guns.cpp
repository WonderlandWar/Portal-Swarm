...
void SwapPaintAndPortalGuns( CPortal_Player *pPlayer1, CPortal_Player *pPlayer2 )
{
	...
	char linkageID = pPortalGun->m_iPortalLinkageGroupID;
...
bool CheckSwapProximity( CPortal_Player *pPlayer1, CPortal_Player *pPlayer2 )
{
	...
	CProp_Portal *pPortal1 = CProp_Portal::FindPortal( pPortalGun->m_iPortalLinkageGroupID, false );
	CProp_Portal *pPortal2 = CProp_Portal::FindPortal( pPortalGun->m_iPortalLinkageGroupID, true );
