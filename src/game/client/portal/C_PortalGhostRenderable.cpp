	...
	m_pOwningPortal( pOwningPortal )
{
	...
	//g_pClientLeafSystem->AddRenderable( this, false, pGhostSource->ComputeTranslucencyType(), RENDERABLE_MODEL_ENTITY );
}
...
{ 
	...
	return m_pGhostedRenderable->ComputeTranslucencyType();
}
...
int C_PortalGhostRenderable::GetRenderFlags()
{
	...
	return m_pGhostedRenderable->GetRenderFlags();
}
