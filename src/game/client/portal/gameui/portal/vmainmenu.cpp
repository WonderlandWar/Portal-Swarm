...
bool SharedMainMenu::OnCommand( const char *command )
{
...
void SharedMainMenu::OnOpenOptionsDialog()
{
	if ( !m_hOptionsDialog.Get() )
	{
		m_hOptionsDialog = new COptionsDialog( mn );
...
void SharedMainMenu::OnOpenOptionsDialog_Xbox()
{
}
